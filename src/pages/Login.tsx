    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-powderblue to-white px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold text-midnight">Welcome to Move Mate Connect</CardTitle>
        ...
        <CardContent>
          <Tabs defaultValue="customer" className="w-full">
            ...
            <TabsContent value="customer">
              <Button
                variant="outline"
                className="w-full py-6 text-lg hover:bg-gray-50"
            ...
            <TabsContent value="partner">
              ...
              >
                ...
                Continue with Google as Partner
              </Button>
            </TabsContent>
            <TabsContent value="vendor">
              ...
              >
                ...
                Continue with Google as Vendor
              </Button>
            </TabsContent>
          </Tabs>
        </CardContent>
